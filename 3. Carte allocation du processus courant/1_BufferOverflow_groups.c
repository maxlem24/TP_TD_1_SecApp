...
int main(void)
{
 ...
 printf("\n==========================\n\n");
  ...
  printf("&main [%p] début du code exécutable de main()\n", &main);
  printf("&proc_inutile [%p] début du code exécutable de procedure_inutile()\n\n", &procedure_inutile);
  printf("&proc_alloca_calloc [%p] début du code exécutable de procedure_avec_alloca_et_calloc()\n\n", &procedure_avec_alloca_et_calloc);
